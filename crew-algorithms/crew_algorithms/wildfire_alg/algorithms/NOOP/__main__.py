...
def wildfire_alg(cfg: Config):
    ...
    from crew_algorithms.wildfire_alg.algorithms.NOOP.agent import Agent
    ...
    path = os.path.join("crew_algorithms", "wildfire_alg","results", "logs", "NOOP", level, str(seed), cfg.envs.timestamp)
